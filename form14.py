...
# Form implementation generated from reading ui file 'form14.ui'
#
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.treeWidget.topLevelItem(1).child(2).setText(0, _translate("MainWindow", "测量次数"))
        self.treeWidget.topLevelItem(1).child(2).setText(1, _translate("MainWindow", "0"))
        self.treeWidget.topLevelItem(1).child(3).setText(0, _translate("MainWindow", "当前运行时间"))
